...
{   
    ...
    auto const logger = rclcpp::get_logger("Planning aroud objects strted.");

    // Spin up a SingleThreadedExecutor
    // for MoveItVisualTools to interact with ROS
    ...
    auto const target_pose = []{
        ...
        msg.orientation.y = 0.796;
        msg.orientation.z = 0.000;
        msg.orientation.w = 0.606;
        msg.position.x = 0.451;
        msg.position.y = -0.236;
    ...
    prompt("Press 'Next' in the RvizVisualToolsGui for create collision object");
    moveit_visual_tools.trigger();
    ...
    prompt("Press 'Next' in the RvizVisualToolsGui for plan around box");
    moveit_visual_tools.trigger();
    ...
    // Execute the plan
    if (success_1) {
        draw_trajectory_tool_path(plan_1.trajectory);
        moveit_visual_tools.trigger();
        prompt("Press 'Next' in the RvizVisualToolsGui window to execute");
        draw_title("Executing");
        moveit_visual_tools.trigger();
