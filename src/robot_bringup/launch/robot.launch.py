...
def generate_launch_description():
    ...
    # Joint limits
    robot_joint_limits_path = os.path.join(
        get_package_share_directory("robot_moveit_config"),
        "config",
        "joint_limits.yaml"
    )
    ...
    # Moveit servo parameters file
    moveit_servo_params_file_path = os.path.join(
    ...
    # Moveit launch file
    moveit_launch_file_path = os.path.join(
        get_package_share_directory("robot_moveit_config"),
        "launch",
    ...
    moveit_servo_params = (
        ...
        .yaml(moveit_servo_params_file_path)
        .to_dict()
    )
    ...
    # Controller manager + controller spawner
